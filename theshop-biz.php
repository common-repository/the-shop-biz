...
<br>
<b>[shop_biz username='your username']Your Shop Name[/shop_biz]</b><br><br>
In case you have an online consultancy portal with TheShop.biz, You can showcase your theShop.biz Consultancy on Wordpress using the following shortcode:
<br>
<b>[shop_biz_consult username='your username']Your Shop Name[/shop_biz_consult]</b>
</center>
...
function shop_biz_consult($atts, $content = null) {
    extract(shortcode_atts(array(
        "username" => ''
    ), $atts));
    return '<iframe src="http://theshop.biz/consult.php?username='.$username.'" width="100%" height="100%"></iframe>'.$content.'</b>';
}
add_shortcode("shop_biz_consult", "shop_biz_consult");
?>